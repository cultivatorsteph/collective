...
class WPPB_Addon_Soundcloud{
	...
	public function render($data = null){
		...
		$output  .= '<div class="wppb-soundcloud-addon">';
			$output  .= '<div class="wppb-soundcloud-content">';
				$output  .= '<iframe scrolling="no" frameborder="no"';
	...
	public function getTemplate(){
		...
		<div class="wppb-soundcloud-addon">
			...
			src="https://w.soundcloud.com/player/?url={{data.link}}&auto_play={{autoplay}}&sharing={{share_button}}&download={{download}}&show_user={{username}}&show_playcount={{play_count}}&buying={{buy_button}}&color={{control_color.replace("#", "")}}&visual={{visual_player}}">
			</iframe>
			</div>
		</div>
		';
