...
class WPPB_Addon_Button{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			// 'appearance' => array(
			// 	'type' => 'select',
			// 	'title' => __('Appearance','wp-pagebuilder'),
			// 	'values' => array(
			// 		'flat' => __('Flat','wp-pagebuilder'),
			// 		'outline' => __('Outline','wp-pagebuilder'),
			// 		'3d' => __('3D','wp-pagebuilder'),
			// 	),
			// 	'std' => 'flat',
			// ),
			...
			// 'button_3d_color' => array(
			// 	'type' => 'color',
			// 	'title' => __('3d Shadow color','wp-pagebuilder'),
			// 	'tab' => 'style',
			// 	'section' => 'Style',
			// 	'depends' => array(array('style', '=', array('custom'))),
			// 	'selector' => '{{SELECTOR}} .wppb-button-addon-content .wppb-btn-addons, {{SELECTOR}} .wppb-btn-custom.wppb-btn-addons:before{ border-bottom-color: {{data.button_3d_color}}; }'
			// ),
			// 'button_3d_hcolor' => array(
			// 	'type' => 'color',
			// 	'title' => __('3d shadow hover color','wp-pagebuilder'),
			// 	'tab' => 'style',
			// 	'section' => 'Style',
			// 	'depends' => array(array('style', '=', array('custom'))),
			// 	'selector' => '{{SELECTOR}} .wppb-button-addon-content .wppb-btn-addons:hover, {{SELECTOR}} .wppb-btn-custom.wppb-btn-addons:before{ border-bottom-color: {{data.button_3d_hcolor}}; }'
			// ),
