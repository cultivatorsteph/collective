...
class WPPB_Addon_Animated_Number{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'additional' => array(
				'type' => 'text',
				'title' => __('Additional Content','wp-pagebuilder'),
				'std' => '+'
			),
			'additional_position' => array(
				'type' => 'select',
				'title' => __('Additional content position','wp-pagebuilder'),
			...
			'additional_color' => array(
				'type' => 'color2',
				'title' => __('Additional color','wp-pagebuilder'),
				'tab' => 'style',
				'section' => 'Additional',
				'clip' => true,
				'std' => array(
			...
			'additional_fontstyle' => array(
				'type' => 'typography',
				'title' => __('Additional typography','wp-pagebuilder'),
				'std' => array(
					'fontFamily' => '',
					'fontSize' => array( 'md'=>'60px', 'sm'=>'', 'xs'=>'' ),
					'lineHeight' => array( 'md'=>'', 'sm'=>'', 'xs'=>'' ),
	...
	public function render($data = null){
		...
		$additional_position     = isset($settings['additional_position']) ? $settings['additional_position'] : '';
		...
		<div class="wppb-animated-counter-addon">
			<div class="wppb-animated-counter-content animated-layout-{{data.animated_layout}}">
				<# if( data.animated_layout == "two" ){ #>
					...
					<# } #>
					<# if(data.digit){ #>
						<# if(data.additional_position == "left"){ #>
						...
						<# } #>
						<# if(data.additional_position == "right"){ #>
							<div class="wppb-count-number-addition">{{ data.additional }}</div>
						<# } #>
					<# } #>	
				<# } else {  #>	
