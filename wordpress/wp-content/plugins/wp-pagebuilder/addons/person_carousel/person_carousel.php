	...
	public function get_settings() {
		...
		$settings = array(
			...
			'dot_bg_hcolor' => array(
				...
				'tab' => 'style',
				'section' => 'Dots Style',
				'selector' => '{{SELECTOR}} .wppb-person-content-carousel .slick-dots li.slick-active button { background: {{data.dot_bg_hcolor}}; }'
			),
			'dot_width' => array(
				'type' => 'slider',
				'title' => __('Width','wp-pagebuilder'),
	...
	public function render($data = null){
		...
		$output  .= '<div class="wppb-person-addon">';
			$output  .= '<div class="wppb-person-carousel-addon-content person-layout-'.esc_attr($person_layout).'">';
				$output  .= '<div class="wppb-person-content-carousel wppb-person-'.esc_attr($column).' '.esc_attr($control_nav_style).'" data-col="'.esc_attr($column).'" data-shownav="'.esc_attr($control_nav).'" data-showdots="'.esc_attr($control_dots).'" data-autoplay="'.esc_attr($autoplay_option).'">';
				...
				if( $person_layout == "layouttwo" ){
						...
						foreach ( $person_list as $key => $value ) {
							...
							$output  .= '<div class="wppb-person-addon-content woww-'.$key.'"">';
								if ( ! empty($value['image']['url']) ) {
									$img_url = $value['image']['url'];
									$output .= '<div class="wppb-person-image">';
										$output .= '<img class="wppb-person-addon-img" src="'.esc_url($img_url).'" alt="'. esc_attr( get_wppb_array_value_by_key($value, 'name') ) .'">';
		...
		$output = '
			...
			<div class="wppb-person-addon">
				<div class="wppb-person-carousel-addon-content person-layout-{{data.person_layout}}">
					<div class="wppb-person-content-carousel wppb-person-{{column}} {{control_nav_style}} " data-col="{{column}}" data-shownav="{{control_nav}}" data-showdots="{{control_dots}}" data-autoplay="{{autoplay_option}}">
