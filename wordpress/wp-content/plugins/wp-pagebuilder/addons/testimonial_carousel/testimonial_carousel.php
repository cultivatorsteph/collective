...
class WPPB_Addon_Testimonial_Carousel{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			'dot_bg_hcolor' => array(
				...
				'tab' => 'style',
				'section' => 'Dots Style',
				'selector' => '{{SELECTOR}} .wppb-testimonial-content-carousel .slick-dots li.slick-active button { background: {{data.dot_bg_hcolor}}; }'
			),
			'dot_width' => array(
				'type' => 'slider',
				'title' => __('Width','wp-pagebuilder'),
	...
	public function render($data = null){
		...
		$output  .= '<div class="wppb-testimonial-content-carousel wppb-testimonial-'.esc_attr($column).' '.esc_attr($control_nav_style).'" data-col="'.esc_attr($column).'" data-shownav="'.esc_attr($control_nav).'" data-showdots="'.esc_attr($control_dots).'" data-autoplay="'.esc_attr($autoplay_option).'">';
		...
		$output = '
			...
			<div class="wppb-testimonial-addon">
				<div class="wppb-testimonial-carousel-addon-content testimonial-layout-{{data.testimonial_layout}}">
					<div class="wppb-testimonial-content-carousel wppb-testimonial-{{column}} {{control_nav_style}} " data-col="{{column}}" data-shownav="{{control_nav}}" data-showdots="{{control_dots}}" data-autoplay="{{autoplay_option}}">
