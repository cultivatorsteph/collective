	...
	public function get_settings() {
		...
		$settings = array(
			...
			'title_bg' => array(
				...
				'section' => 'Pricing Title',
				'selector' => '{{SELECTOR}} .pricing-layout-two .wppb-pricing-title-wrap,
				{{SELECTOR}} .pricing-layout-one .wppb-pricing-title-wrap',
				'depends' => array(array('pricing_layout', '!=', array('three'))),
			),
			...
			'subtitle_margin' => array(
				'type' => 'slider',
				'title' => __('Sub margin bottom','wp-pagebuilder'),
				'unit' => array( 'px','%','em' ),
				'range' => array(
						'em' => array(
							'min' => 0,
				...
				'tab' => 'style',
				'section' => 'Pricing Sub title',
				'selector' => '{{SELECTOR}} .wppb-pricing-subtitle { margin-bottom: {{data.subtitle_margin}}; }',
				'depends' => array(array('pricing_layout', '!=', array('three'))),
			),	
			...
			'icon_section_bg' => array(
				...
				'selector' => '{{SELECTOR}} .wppb-pricing-table-icon,
				{{SELECTOR}} .pricing-layout-two .wppb-pricing-table-icon,
				{{SELECTOR}} .pricing-layout-one .wppb-pricing-table-icon',
				'depends' => array(array('pricing_layout', '!=', array('three'))),
			),
			'icon_size' => array(
				'type' => 'slider',
