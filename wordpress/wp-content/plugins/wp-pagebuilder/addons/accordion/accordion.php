...
class WPPB_Addon_Accordion{
	...
	public function get_settings() {
		...
		$settings = array(
			...
			// 'first_item_border' => array(
			// 	'type' => 'switch',
			// 	'title' => __('Disable first item top border','wp-pagebuilder'),
			// 	'std' => '0',
			// 	'tab' => 'style',
			// 	'section' => 'Border',
			// ),
			// 'last_item_border' => array(
			// 	'type' => 'switch',
			// 	'title' => __('Disable bottom item top border','wp-pagebuilder'),
			// 	'std' => '0',
			// 	'tab' => 'style',
			// 	'section' => 'Border',
			// ),
	...
	public function render($data = null){
		...
		//$first_item_border 	= isset($settings["first_item_border"]) ? $settings["first_item_border"] : '';
		//$last_item_border 	= isset($settings["last_item_border"]) ? $settings["last_item_border"] : '';
		...
		$output = '';
		// if($first_item_border == '0') {
		// 	$first_item_border = 'wppb-accordion-top-disable';
		// } else {
		// 	$first_item_border = 'wppb-accordion-top-enable';
		// }

		// if($last_item_border == '0') {
		// 	$last_item_border = 'wppb-accordion-bottom-disable';
		// } else {
		// 	$last_item_border = 'wppb-accordion-bottom-enable';
		// }

		$output  .= '<div class="wppb-accordion-addon">';
		$output  .= '<div class="wppb-accordion-addon-content">';
		//$output  .= '<div class="wppb-accordion-items '.$first_item_border.' '.$last_item_border.'">';
