		...
		public function print_edit_with_wp_pagebuilder_button(){
			...
			<script id="wppb-edit-with-btn-in-gutenberg-toolbar" type="text/html">
				<div class="wppb-editor-warper">
					<a href="<?php echo wppb_helper()->get_editor_url($post->ID); ?>" class="components-button  is-button is-primary edit-with-wppb-builder"><?php _e('Edit With WP Page Builder','wp-pagebuilder');?></a>
				</div>
			</script>
			<?php
		}
