		...
		public function wppb_enqueue_scripts(){
			...
			if( wppb_helper()->is_editor_screen() ){
				...
				$js_translate = array(
					...
					'font_weight' => __('Font Weight','wp-pagebuilder'), 'text_transform' => __('Text Transform','wp-pagebuilder'),'disable' => __('Disable','wp-pagebuilder'),'enable' => __('Enable','wp-pagebuilder'), 
