			...
			$global_attribute = array(
				...
				'advanced' => array(
					...
					'addon_opacity' => array(
						...
						'selector' => '{{SELECTOR}}:after{ content: " "; z-index: -1; display: block; position: absolute; height: 100%; top: 0; left: 0; right: 0; opacity:{{data.addon_opacity}}; }',
						'section' => 'Overlay',
					),
					'addon_border' => array(
						'type' => 'border',
					...
					'addon_border_radius' => array(
						...
						'unit' => array( 'px','em','%' ),
						'responsive' => true,
						'selector' => '{{SELECTOR}}, {{SELECTOR}}:after{ border-radius: {{data.addon_border_radius}} ; }',
						'section' => 'Border Radius',
					...
					'addon_border_radius_hover' => array(
						...
						'unit' => array( 'px','em','%' ),
						'responsive' => true,
						'selector' => '{{SELECTOR}}:hover, {{SELECTOR}}:hover:after{ border-radius: {{data.addon_border_radius_hover}} ; }',
						'section' => 'Border Radius',
						'depends' => array( array( 'addon_border_radius_check', '=', '1' ) ),
					),
